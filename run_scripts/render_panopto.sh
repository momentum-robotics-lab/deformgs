...
do
    python3 render_experimental.py --model_path "output/panopto/${SCENE}_no_grid_0.25"  --configs arguments/mdnerf-dataset/cube.py --view_skip 20 --time_skip 1 --scale 0.25 --skip_video \
