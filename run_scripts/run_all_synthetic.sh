...
do
    ...
    do 
       ...
       --checkpoint_iterations 1000 19000 20000 --lambda_cotrack 0.3 \
       --k_nearest 20 --lambda_isometric $isometry --reg_iter 11000 --staticfying_from 10000 --use_wandb --wandb_project "paper_final_${SCENE}_bg"  --wandb_name "init" 
        port=$((port+1))
    done
done
