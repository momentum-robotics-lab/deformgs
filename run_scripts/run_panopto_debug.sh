...
do
    ...
    --mask_loss_from 2000 --checkpoint_iterations 0 100 --no_coarse --start_checkpoint output/panopto/fold_cloth_short_reg_coarse_all/chkpnt_20000_fine.pth --start_from_iter 0 
    port=$((port+1))
done
