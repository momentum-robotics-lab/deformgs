...
do
    ...
    do 
        ...
        python3 render_experimental.py --model_path "output/final_scenes_bg_20m_range_exp_iso/${SCENE}" --configs arguments/mdnerf-dataset/cube.py --skip_train --skip_video --view_skip 50 --time_skip 1 --log_deform \
